...
((SELECT dog_id FROM Dogs WHERE name = 'Barney'), '2025-06-10 12:00:00', 30, 'Beach', 'open'),
((SELECT dog_id FROM Dogs WHERE name = 'Buster'), '2025-06-10 :00:00', 30, 'Dog Park', 'cancelled'),
((SELECT dog_id FROM Dogs WHERE name = 'Louis'), '2025-06-10 08:00:00', 30, 'Plaza', 'accepted'),
...
((SELECT dog_id FROM Dogs WHERE name = 'Barney'), '2025-06-10 08:00:00', 30, 'Beach', 'open'),
((SELECT dog_id FROM Dogs WHERE name = 'Buster'), '2025-06-10 08:00:00', 30, 'Parklands', 'cancelled'),
((SELECT dog_id FROM Dogs WHERE name = 'Louis'), '2025-06-10 08:00:00', 30, 'Parklands', 'accepted'),